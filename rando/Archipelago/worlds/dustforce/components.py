...
# Dustforce has a Python client inside the apworld that contains the entire game. This is a component.
# Dustforce will not teach you how to make a client or any other type of component.
...
def run_client(*args: str) -> None:
    ...
    launch(launch_ap_quest_client, name="Dustforce Client", args=args)
...
# As you can see above, the Dustforce client has both of these parameters set.
# This means a user can click on the slot name of an Dustforce slot on WebHost,
# then click "Dustforce Client" instead of "Text Client" in the Launcher popup, and after a few seconds,
