...
from . import options as dustforce_options  # rename due to a name conflict with World.options

# Dustforce will go through all the parts of the world api one step at a time,
...
class DustforceWorld(World):
    """
    Dustforce is a momentum based precision platformer where you play as a janitor cleaning up dust.
    """
    ...
    web = web_world.DustforceWebWorld()

    # This is how we associate the options defined in our options.py with our world.
    # (Note: options.py has been imported as "dustforce_options" at the top of this file to avoid a name conflict)
    options_dataclass = dustforce_options.DustforceOptions
    options: dustforce_options.DustforceOptions  # Common mistake: This has to be a colon (:), not an equals sign (=).
    ...
    def create_item(self, name: str) -> items.DustforceItem:
