...
const uint LAVENDER = 0xFFFCB4D5;
const uint SALMON = 0xFFFF9BAA;
const uint MAUVELOUS = 0xFFEF98AA;
const uint MAHOGANY = 0xFFCD4A4A;
const uint BURNTSIENNA = 0xFFEA7E5D;
const uint MACARONIANDCHEESE = 0xFFFFBD88;
const uint GOLDENROD = 0xFFFCD975;
const uint SPRINGGREEN = 0xFFECEABE;
const uint OLIVEGREEN = 0xFFBAB86C;
const uint GRANNYSMITHAPPLE = 0xFFA8E4A0;
const uint SEAGREEN = 0xFF9FE2BF;
const uint CORNFLOWER = 0xFF9ACEEB;
const uint PURPLEMOUNTAINSMAJESTY = 0xFF9D81BA;
